 ...
 * @author w.vela
 */
public abstract class AbstractLazyZkBasedByteNodeResource<T>
        extends AbstractZkBasedByteNodeResource<T> {
     ...
     * @param clientFactory
     */
    private AbstractLazyZkBasedByteNodeResource(String monitorPath, CuratorFramework client,
     ...
     * @param client
     */
    public AbstractLazyZkBasedByteNodeResource(String monitorPath, CuratorFramework client) {
     ...
     * @param clientFactory
     */
    public AbstractLazyZkBasedByteNodeResource(String monitorPath,
            Supplier<CuratorFramework> clientFactory) {
